...
routes.get("/usuario/atualizar/:email", usuarioController.atualizar);

routes.post("/usuario", usuarioController.cadastrar);

routes.post("/usuario/editar", usuarioController.atualizarPost);

routes.get("/usuario/login", usuarioController.loginGet);

routes.post("/usuario/login", usuarioController.loginPost);

routes.post("/usuario/email", usuarioController.atualizarPost);
